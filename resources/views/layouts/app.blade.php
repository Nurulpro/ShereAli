                        ...
                        <div class="top_bar_content ml-auto">
                            <div class="top_bar_menu">
                                <ul class="standard_dropdown top_bar_dropdown">
                                     <li>
                                        <a href="#" data-toggle="modal" data-target="#exampleModalLong">Order Tracking</a>
                            ...
                            <div class="top_bar_user">
                                 ...
                                 <div><a href=""></a></div>
                                 @guest
                                 <div><a href="{{ route('login') }}"> Sign Up/Sign In</a></div>
                                 @else
                                
                                 <ul class="standard_dropdown top_bar_dropdown">
                                    <li>
                                    <div> <div class="user_icon"><img src="{{asset('public/frontend/images/user.svg') }}" alt=""></div>
                                    <a href="{{ route('home') }}">Profile</a></div>
                                        <ul>
                            ...
                            <div class="cart">
                                <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                    ...
                                    <div class="cart_content">
                                        <div class="cart_text"><a href="{{route('product/card')}}">Cart</a></div>
                                        @if(Session::has('coupon'))
                                         <div class="cart_price">$({{ Session::get('coupon')['balance'] + $shippingcharge}})</div>
                                        @else
                                         <div class="cart_price">${{Cart::Subtotal()+$shippingcharge }}</div>
                                        @endif
            ...
            <div class="row">
                ...
                <div class="col-lg-3 footer_col">
                    <div class="footer_column footer_contact">
                        <div class="logo_container">
                            <div class="logo"><a href="#">ShereAli</a></div>
                        </div>
                        <div class="footer_title">Got Question? Call Us 24/7</div>
                        <div class="footer_phone">+8801821554477</div>
