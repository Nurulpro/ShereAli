...
@section('content')
@include('layouts.meanubar')

@php
$featured=DB::table('products')->where('status',1)->orderBy('id','desc')->limit(20)->get();
$treand=DB::table('products')->where('products.status',1)->where('trend',1)->orderBy('id','desc')->limit(20)->get();
$bestrated=DB::table('products')->where('status',1)->where('best_rated',1)->orderBy('id','desc')->limit(20)->get();
$hotdeal=DB::table('products')->join('brands','products.brand_id','brands.id')->select('products.*','brands.brand_name')->where('products.status',1)->where('hot_deal',1)->orderBy('id','desc')->limit(10)->get();
@endphp
 <!-- Characteristics -->
   ...
   <!-- Deals of the week -->
            ...
            <div class="col d-flex flex-lg-row flex-column align-items-center justify-content-start">
                    ...
                    <div class="featured">
                        <div class="tabbed_container">
                            <div class="tabs">
                                <ul class="clearfix" >
                                    <li class="active">New Featured Product</li>
                                </ul>
    ...
    <!-- Banner -->
    @php
    $midslider=DB::table('products')->join('categories','products.category_id','categories.id')
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        ...
                                        <div class="banner_2_title">{{$mid->product_details}}</div>
                                        <div class="banner_2_text">{{$mid->brand_name}}</div>
