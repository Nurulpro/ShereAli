                                ...
                                <li class="cart_item clearfix">
                                    ...
                                    <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                        <div class="cart_item_name cart_info_col">
                                            <img src="{{asset($row->options->image)}}" style="height: 50px", width="50px">
                       ...
                       <form action="{{route('stripe.charge')}}" method="post" id="payment-form" style="border: 1px solid grey; padding: 20px;">
                        ...
                        {{--   extra data --}}
                         ...
                         <input type="hidden" name="payment_type" value="{{ $data['payment'] }}">
                          <button class="btn btn-info">Pay Now</button><br>
...
var stripe = Stripe('pk_test_51IU5xPBZdkLUA1X2A11DhhSe5DlAnES8Gq6YJMArZkKPKDZp3jq5DznUXTpgj46aI1QPZoXflb8L0LzcQwntvV7900xMc2oYPM');
