					 ...
					 <div class="order_total_content " style="padding: 14px;">
						...
						<ul class="list-group col-lg-4" style="float: right;">
                             ...
                             <li class="list-group-item">Shipping Charge: <span style="float: right;"> {{$shippingcharge}} </span></li>
							  ...
							  @if(Session::has('coupon'))
							  	  <li class="list-group-item">Total: <span style="float: right;"> ({{   Session::get('coupon')['balance'] + $shippingcharge}}) </span> </li>
							  @else

							       <li class="list-group-item">Total:{{Cart::Subtotal()+$shippingcharge }}  <span style="float: right;">$  </span> </li>
							  @endif
