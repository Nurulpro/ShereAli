...
<html lang="en">
  ...
  <body>
   ...
   @else
   <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>ShereAli.com</a></div>
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Category Subcat Brand</span>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{route('admin.payment.accepted')}}" class="nav-link">Payment Accepted</a></li>
          <li class="nav-item"><a href="{{route('admin.cancle.order')}}" class="nav-link">Cancle Order</a></li>
          <li class="nav-item"><a href="{{route('admin.progress.order')}}" class="nav-link">Progress Order</a></li>
           <li class="nav-item"><a href="{{route('admin.delevered.order')}}" class="nav-link">Delevered Order</a></li>
           <li class="nav-item"><a href="{{route('admin.handover.order')}}" class="nav-link">Hand Over</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{route('admin.seosetting')}}" class="nav-link">Seo Settings</a></li>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="{{route('admin.mail.change')}}"><i class="icon ion-ios-gear-outline"></i>Change Email</a></li>
  ...
  <!-- vendor css -->
    ...
    <script src="{{asset('public/backend/lib/summernote/summernote-bs4.min.js')}}"></script>
     <script src="{{asset('public/backend/lib/modernizr-2.6.2.min.js')}}"></script>
