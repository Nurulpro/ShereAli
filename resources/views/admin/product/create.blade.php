              ...
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                  ...
                  <select class="form-control select2" data-placeholder="Choose country" name="brand_id">
                    ...
                    @foreach($brand as $br)
                    <option value="{{$br->id}}"><img src="{{$br->brand_logo}}" style="height: 30px; width:30px">
              ...
              <div class="col-lg-4">
                ...
                <div class="form-group">
                  <label class="form-control-label">Product Details<span class="tx-danger">*</span></label>
                   <input class="form-control" type="text" name="product_details" placeholder="Product Details" >
                </div>  
              </div>
